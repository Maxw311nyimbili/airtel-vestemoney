...
export default function Header({ showToast, onLogout, isGuest, isDarkMode, toggleDarkMode }) {
        ...
        <React.Fragment>
          ...
          <div className="help-sheet">
            ...
            <div className="help-contact-row">
              <a className="help-contact-btn" href="tel:111" onClick={e => { e.preventDefault(); showToast('Calling Airtel support on 111…'); }}>
